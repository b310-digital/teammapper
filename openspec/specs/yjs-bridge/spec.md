...
Defines how the frontend writes renderer events into the Y.Doc and applies remote Y.Doc changes to the renderer, including import, load and map deletion.
